...
// float (4 byte), double (8 byte, число с двойной точностью), long double (16 byte, число с четверной точностью)
// четкое следование стандарту с плавающей точкой
// количество разрядов после запятой - неограниченное количество // погрешность ...
