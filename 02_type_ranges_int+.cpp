...
// стандарт языка C++ говорит, что Int это самый эффективный тип для текущей платформы для представления целых чисел
// этот тип совпадает по размеру с регистрами общего назначения в процессоре, которых максимальное количество
// размер типа int имеет фактически электротехнические/электронные предпосылки
// short в два раза меньше , но может и не имеет смыла , если на другой платформе int - 4 byte
